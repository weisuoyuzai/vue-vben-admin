...
import type { VisibleDomRect } from '#/@core/base/shared/src/utils';
...
} from '#/@core/base/shared/src/constants';
import { getElementVisibleRect } from '#/@core/base/shared/src/utils';
